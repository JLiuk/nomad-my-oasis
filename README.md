![docker image](https://github.com/JLiuk/nomad-my-oasis/actions/workflows/docker-publish.yml/badge.svg)


# JLiuk's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of JLiuk.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/JLiuk/nomad-my-oasis.git
    cd nomad-my-oasis
    ```
    ...
    ```sh
    curl-L -o nomad-my-oasis.zip "https://github.com/JLiuk/nomad-my-oasis/archive/main.zip"
    unzip nomad-my-oasis.zip
    cd nomad-my-oasis
    ```
...
your `docker-compose.yaml` with `ghcr.io/jliuk/nomad-my-oasis:main` for the services
...
and advanced configuration, see the [nomad-helm-charts](https://github.com/JLiuk/nomad-helm-charts) repository.
...
By default, no plugins are included in this distribution. You can find a list of available NOMAD plugins [here](https://nomad-lab.eu/prod/v1/oasis/gui/search/plugins). For a list of official plugins provided by FAIRmat, please see [here](https://github.com/JLiuk/.github/blob/main/profile/README.md). For inspiration, you can also check the list of [plugins that are installed on the production NOMAD deployment hosted by FAIRmat](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-distro/-/raw/main/pyproject.toml?ref_type=heads).
...
```sh
docker pull ghcr.io/jliuk/nomad-my-oasis/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/JLiuk/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/JLiuk/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/JLiuk/nomad-my-oasis/manifests/main": unauthorized`
